...
export default function CertificadosPage() {
  ...
  // Simulando que o aluno completou o primeiro curso
  const certificados = [
    {
      id: 'cert_1',
      curso: MOCK_CURSOS[0].titulo,
      dataConclusao: '15/05/2026',
      cargaHoraria: MOCK_CURSOS[0].duracaoHoras,
      codigo: 'CERT-AG-89472A'
    }
  ];
