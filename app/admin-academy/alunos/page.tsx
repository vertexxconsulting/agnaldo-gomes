...
import { Search, Filter, MoreVertical, Edit2, Shield, Lock, Trash2 } from 'lucide-react';
import { Button } from '@/components/Button';

// Mock de alunos
const MOCK_ALUNOS = [
  { id: '1', nome: 'João Silva', email: 'joao.silva@email.com', cursos: ['Cabeleireiro Iniciante'], progresso: 45, status: 'Ativo' },
  { id: '2', nome: 'Maria Oliveira', email: 'maria.oliveira@email.com', cursos: ['Cortes Avançados', 'Colorimetria'], progresso: 12, status: 'Ativo' },
  { id: '3', nome: 'Carlos Souza', email: 'carlos.souza@email.com', cursos: ['Cabeleireiro Iniciante'], progresso: 100, status: 'Concluído' },
  { id: '4', nome: 'Ana Costa', email: 'ana.costa@email.com', cursos: [], progresso: 0, status: 'Inativo' },
  { id: '5', nome: 'Pedro Santos', email: 'pedro.santos@email.com', cursos: ['Colorimetria'], progresso: 80, status: 'Bloqueado' },
];
